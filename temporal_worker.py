...
async def run_worker():
    ...
    worker = Worker(
        ...
        workflows=[temporal_workflows.CompleteAdmissionWorkflow],
        activities=[
            temporal_activities.run_daft_processing,
            temporal_activities.run_pydantic_validation,
            temporal_activities.run_distributed_pipeline,
            temporal_activities.run_iceberg_integration,
